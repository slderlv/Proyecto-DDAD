...
export function SideMenu(user: Users) {
    return(
<div className="flex h-screen flex-col justify-between border-e bg-white">
  ...
  <div className="sticky inset-x-0 bottom-0 border-t border-gray-100">
    <a href="/profile" className="flex items-center gap-2 bg-white p-4 hover:bg-gray-50">
      <img
        alt="Man"
      ...
      <div>
        <p className="text-xs">
          <strong className="block font-medium"> {user.info.first_name}&nbsp;{user.info.last_name} </strong>
